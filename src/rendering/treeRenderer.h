...
public:
    TreeRenderer(std::shared_ptr<Mesh> mesh, std::shared_ptr<Material> baseMaterial, std::shared_ptr<Mesh> billboardMesh, std::shared_ptr<Material> billboardMaterial);
